    ...
    <div class="firstPage">
        <div class="container">
			<header>
					...
					<form class="left w50" id="firstPage" @submit.prevent="validateBeforeSubmit()" v-on:submit="submitToNext">
					...
					<form class="right w50" id="firstPage" @submit.prevent="validateBeforeSubmit()" v-on:submit="submitToNext">
						<div class="form-group row">
							<div class="col-sm-12">
						...
						<div class="form-group row">
							<div class="col-lg-12 text-center">
								<button type="submit" class="btn">Próxima Etapa</button>
							</div>
						</div>
					</form>
        </div>
